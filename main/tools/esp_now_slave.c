...
static void esp_now_receive_callback(const uint8_t *mac_addr, const uint8_t *data, int len)
{
    esp_now_event_t evt;
...
static void set_peer_esp_now(esp_now_peer_info_t *peer, esp_now_event_recv_cb_t *recv_cb)
{
